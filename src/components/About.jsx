...
import resume from "../resume/Vinod_Kumar_G_Resume.pdf"
import AOS from "aos";

export default function About() {

  const handleDownload = () => {
    window.open("https://drive.google.com/file/d/1Cd8ILKCoeqjryHhfCvH5OzLO7LA8N345/view?usp=drive_link", '_blank');
  };
    ...
    <section data-aos="fade-up" className="about section sections" id="about">
      ...
      <div>
        <div data-aos="fade-up" className=" first">
          ...
          Welcome to my coding realm, where I transform coffee into lines of code! <p style={{ display: 'inline-block' }} className="sauce">I'm Vinod </p>
        ...
        rel="noreferrer" href={resume} download={"Vinod_Kumar_G_Resume"} id="resume-button-2" className="contact-button resume-button second-btn">
          Resume</a>
      </div>
    </section>
  );
